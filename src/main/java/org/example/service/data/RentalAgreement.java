...
public class RentalAgreement {
    ...
    public RentalAgreement(
        ...
        this.dailyCharge = price.getDailyPrice();
        this.chargeDays =
                dates.getChargeDays(
                        price.isWeekdayCharge(), price.isHolidayCharge(), price.isWeekendCharge());
        ...
        this.discountAmount = reducedPrecision.add(this.preDiscountCharge).multiply(this.discountPercent).divide(100);
        this.finalCharge = reducedPrecision.add(this.discountAmount).negate().add(this.preDiscountCharge);
